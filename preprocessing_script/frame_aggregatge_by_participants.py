...
OUT_FILE = OUTPUT_DIR / "FRAME_LEVEL_EYE_METRICS_BySubJ.csv"
...
fix_frame_avg = (
    fix_clean
    .groupby(["subject", "movie", "calc_frame"], dropna=False)
    .agg(
...
frame_participant_level = fix_frame_avg.merge(
    sacc_frame_avg,
    on=["subject", "movie", "calc_frame"],
    how="outer",
    suffixes=("_fix", "_sacc")
)
...
frame_participant_level.to_csv(OUT_FILE, index=False)
